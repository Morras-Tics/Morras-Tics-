...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  function render(lista) {
    ...
    lista.forEach((a) => {
      ...
      card.innerHTML = `
        ${a.imagen ? `<img src="${a.imagen}" class="img-articulo" alt="${a.titulo}">` : ""}
        ...
        <div class="contenido">
          ...
          <div id="comentarios-${a.id}" class="comentarios-box" style="display:none;">
            ...
            <textarea id="input-${a.id}" placeholder="Escribe un comentario..."></textarea>
            <button onclick="comentar(${a.id})">Enviar comentario</button>
          </div>
        </div>
      `;
  ...
  window.verArticulo = (id) => {
    ...
    modal.innerHTML = `
      <div class="modal-contenido">
        ...
        ${articulo.imagen ? `<img src="${articulo.imagen}" class="img-modal">` : ""}
